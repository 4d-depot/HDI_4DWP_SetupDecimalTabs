...
Case of 
	...
	Else 
		...
		$options.title:="setup decimal tabulation?"+" Which character should be used?"
		
		$options.blog:="blog.4d.com"
		$options.info:="4D Write Pro"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="1850"  // 1850 means 18R5   1804 means 18.5 (do not use !)
